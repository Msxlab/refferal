...
export default function CompaniesPage() {
  ...
  return (
    <div>
      ...
      {toast && (
        <div style={{ position: 'fixed', bottom: 24, left: '50%', transform: 'translateX(-50%)', background: 'var(--foil)', color: 'var(--on-gold)', padding: '8px 16px', borderRadius: 10, fontSize: 13, fontWeight: 600, zIndex: 50 }}>{toast}</div>
      )}
    </div>
  );
}
