...
| 2. Server-authoritative hierarchy reads | in progress | hierarchy_task2b_impl | 20 focused contract/token tests + API typechecks for 2A | Subtask 2A completed in `88bc3e7` and `eeca319`, independently reviewed clean; service/controller/migration integration is now in progress. |
